...
function sendEmail(email, sender) {
    ...
    const message = {
        ...
        text: '',
        html: `<img src="/images/healthhub-logo.png" width="65px" height="60px" alt="FoodHub.SG Logo">
                <span style="color: #707070; font-weight: bold; font-size: 30px;">FoodHub.SG</span><br><br>
